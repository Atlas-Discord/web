...
function initPage() {
    ...
    var inicio_content = "Inicio";
    var equipe_content = 'Equipe';
    var blog_content = 'Blog';
    var suporte_content = 'Suporte';
    var incio_href = "#";
    var equipe_href = "#";
    var blog_href = "#";
    var suporte_href = "#";
    ...
    function __collapse_genessis() {
        ...
        collapse_content_ul_li_1_a.href = '#';
        ...
        collapse_content_ul_li_4_a.href = '#';
